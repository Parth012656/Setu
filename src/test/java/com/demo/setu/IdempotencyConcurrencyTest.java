...
import com.demo.setu.crypto.HybridCryptoService;
import com.demo.setu.crypto.ServerKeyHolder;
import com.demo.setu.model.MeshPacket;
import com.demo.setu.model.PaymentInstruction;
import com.demo.setu.model.AccountRepository;
import com.demo.setu.service.BridgeIngestionService;
import com.demo.setu.service.PaymentOrchestrationService;
import com.demo.setu.service.IdempotencyService;
...
class IdempotencyConcurrencyTest {
    ...
    @Autowired private PaymentOrchestrationService paymentOrchestrationService;
    ...
    void singlePacketDeliveredByThreeBridgesSettlesExactlyOnce() throws Exception {
        ...
        MeshPacket packet = paymentOrchestrationService.createPacket(
